...
final class BadgeLibrary
{
    ...
    public static function all(): array
    {
        ...
        self::$badges = [
            'secure_checkout' => [
                'label' => __('Secure checkout (lock)', 'plogins-trust'),
            ...
            'ssl_encrypted' => [
                'label' => __('SSL encrypted', 'plogins-trust'),
            ...
            'money_back' => [
                'label' => __('Money-back guarantee', 'plogins-trust'),
            ...
            'verified' => [
                'label' => __('Verified / trusted store', 'plogins-trust'),
            ...
            'free_shipping' => [
                'label' => __('Free shipping (truck)', 'plogins-trust'),
            ...
            'card_payment' => [
                'label' => __('Card payment', 'plogins-trust'),
            ...
            'wallet' => [
                'label' => __('Digital wallet', 'plogins-trust'),
            ...
            'support' => [
                'label' => __('24/7 support (headset)', 'plogins-trust'),
            ...
            'privacy' => [
                'label' => __('Privacy protected', 'plogins-trust'),
            ...
            'satisfaction' => [
                'label' => __('Satisfaction (thumbs up)', 'plogins-trust'),
