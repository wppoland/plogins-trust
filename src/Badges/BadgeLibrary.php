...
final class BadgeLibrary
{
    ...
    public static function all(): array
    {
        ...
        self::$badges = [
            'secure_checkout' => [
                'label' => __('Secure checkout (lock)', 'fidindo'),
            ...
            'ssl_encrypted' => [
                'label' => __('SSL encrypted', 'fidindo'),
            ...
            'money_back' => [
                'label' => __('Money-back guarantee', 'fidindo'),
            ...
            'verified' => [
                'label' => __('Verified / trusted store', 'fidindo'),
            ...
            'free_shipping' => [
                'label' => __('Free shipping (truck)', 'fidindo'),
            ...
            'wallet' => [
                'label' => __('Digital wallet', 'fidindo'),
            ...
            'support' => [
                'label' => __('24/7 support (headset)', 'fidindo'),
            ...
            'privacy' => [
                'label' => __('Privacy protected', 'fidindo'),
            ...
            'satisfaction' => [
                'label' => __('Satisfaction (thumbs up)', 'fidindo'),
