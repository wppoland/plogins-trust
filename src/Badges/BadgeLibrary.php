...
final class BadgeLibrary
{
    ...
    public static function all(): array
    {
        ...
        self::$badges = [
            'secure_checkout' => [
                'label' => __('Secure checkout (lock)', 'badgevo'),
            ...
            'ssl_encrypted' => [
                'label' => __('SSL encrypted', 'badgevo'),
            ...
            'money_back' => [
                'label' => __('Money-back guarantee', 'badgevo'),
            ...
            'verified' => [
                'label' => __('Verified / trusted store', 'badgevo'),
            ...
            'free_shipping' => [
                'label' => __('Free shipping (truck)', 'badgevo'),
            ...
            'wallet' => [
                'label' => __('Digital wallet', 'badgevo'),
            ...
            'support' => [
                'label' => __('24/7 support (headset)', 'badgevo'),
            ...
            'privacy' => [
                'label' => __('Privacy protected', 'badgevo'),
            ...
            'satisfaction' => [
                'label' => __('Satisfaction (thumbs up)', 'badgevo'),
